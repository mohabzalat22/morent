...
function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const user = await api.get(`${import.meta.env.VITE_API_PATH}/user`, {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="flex w-full max-w-7xl mx-auto h-[90vh] shadow-2xl rounded-3xl overflow-hidden bg-white dark:bg-gray-800">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 py-12">
          <div className="mb-8">
            <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-2">Back to the road!</h1>
        ...
        <div className="hidden md:block md:w-1/2 relative">
          ...
          <div className="absolute bottom-12 left-12 text-white p-8 max-w-lg">
             <h2 className="text-4xl font-bold mb-4">Journey with Confidence.</h2>
             <p className="text-lg opacity-90">Experience the best car rental service with premium support and affordable prices.</p>
          </div>
        </div>
