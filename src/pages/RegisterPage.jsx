...
function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      const res = await api.post(`${import.meta.env.VITE_API_PATH}/register`, { 
        name, 
        email, 
        password,
      ...
      <div className="flex w-full max-w-7xl mx-auto h-[90vh] shadow-2xl rounded-3xl overflow-hidden bg-white dark:bg-gray-800">
         ...
         <div className="hidden md:block md:w-1/2 relative bg-gray-900">
          ...
          <div className="absolute top-12 left-12 text-white p-8 max-w-lg">
             <h2 className="text-4xl font-bold mb-4 drop-shadow-lg">Start your Engine.</h2>
             <p className="text-lg opacity-90 ">Join thousands of satisfied customers and hit the road with style.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 py-12 overflow-y-auto">
          <div className="my-8">
            <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-2 mt-4">Create Account</h1>
            <p className="text-gray-500 dark:text-gray-400">Join us today! Please enter your details.</p>
          </div>
